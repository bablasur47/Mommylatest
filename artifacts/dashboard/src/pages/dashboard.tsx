  ...
  return (
    <div className="space-y-6 slide-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Servers" icon={Server} value={stats?.totalServers} loading={statsLoading} color="primary" emoji="🌸" />
        <StatCard title="Total Users" icon={Users} value={stats?.totalUsers} loading={statsLoading} color="purple" emoji="💖" />
        <StatCard title="Messages" icon={MessageSquare} value={stats?.totalMessages} loading={statsLoading} color="accent" emoji="💬" />
        <StatCard title="Active Today" icon={Activity} value={stats?.activeToday} loading={statsLoading} color="yellow" emoji="⚡" />
      </div>
